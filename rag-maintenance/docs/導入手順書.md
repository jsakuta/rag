...
![Toolkit サインイン](screenshots/step8-toolkit-signin.png)
...
![Provision 完了](screenshots/step8-provision-completed.png)
...
SPOへのログインとポータルアクセスの参考スクリーンショット:

![SPO ログイン](screenshots/step11-spo-login.png)

![SPO パスワード入力](screenshots/step11-spo-password.png)

![SPO 2FA認証](screenshots/step11-spo-2fa.png)

![SPO ポータル読み込み](screenshots/step11-spo-portal-loading.png)
...
![Deploy 実行中](screenshots/step13-deploy-executing.png)

![Deploy 完了](screenshots/step13-deploy-completed.png)
...
| `bots[0].scopes` | `["copilot","personal","team"]` | `["personal","team"]` | copilot スコープ不要 |
...
![Publish 完了](screenshots/step14-publish-completed.png)
...
![管理センター ブロック済み](screenshots/step14-admin-blocked.png)

4. アプリをクリック → 詳細画面で「**公開**」ボタンをクリック

![管理センター 公開ボタン](screenshots/step14-admin-publish-button.png)

5. 確認ダイアログで「**公開**」を選択

![公開確認ダイアログ](screenshots/step14-admin-publish-confirm.png)
...
![F5 アカウント選択](screenshots/step13-f5-signin-account-select.png)

![F5 アプリ詳細](screenshots/step13-f5-teams-app-detail.png)

![F5 アプリ起動](screenshots/step13-f5-teams-app-open.png)

![F5 チャネル選択](screenshots/step13-f5-teams-channel-select.png)
...
![Teams Web トップ](screenshots/step13_01_teams_web_top.png)

2. 左サイドバーの「アプリ」→「アプリストア」を開く

![アプリストア](screenshots/step13_02_apps_store.png)

3. 「**組織向けに開発**」セクションでアプリを確認

![組織向けアプリ](screenshots/step13_03_org_apps.png)

4. アプリをクリック →「**追加**」ボタンを押す

![アプリ詳細](screenshots/step13_04_app_detail.png)

5. 追加完了 → Bot との 1:1 チャットが開く

![追加完了](screenshots/step13_05_app_added.png)

![Bot チャットオープン](screenshots/step13_05b_bot_chat_open.png)

6. メッセージを送信 → Adaptive Card で検索カードが応答されることを確認

![Bot 応答（Adaptive Card）](screenshots/step13_06_bot_response.png)
